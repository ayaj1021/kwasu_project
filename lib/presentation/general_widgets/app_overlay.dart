...
import 'package:kwasu_app/presentation/general_widgets/app_loader.dart';
import 'package:kwasu_app/utils/enums.dart';
import 'package:kwasu_app/utils/typedefs.dart';
                ...
                children: [
                  if (messageText?.title != null)
                    Text(
                      ...
                      // Theme.of(context).textTheme.s12w700.copyWith(
                      //       color: messageColor,
                      //     ),
                      textDirection: TextDirection.ltr,
                    ),
                  Text(
                    ...
                    // Theme.of(context).textTheme.s12w400.copyWith(
                    //       color: messageColor,
                    //     ),
                    textDirection: TextDirection.ltr,
                  ),
